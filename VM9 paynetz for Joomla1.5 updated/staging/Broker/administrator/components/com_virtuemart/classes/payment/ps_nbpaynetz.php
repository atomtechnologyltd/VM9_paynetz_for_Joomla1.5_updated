...
/**
*
* The ps_nbpaynet class, containing the Atom paynetz payment processing code
* for netbanking
* @author Ashish Solanki
*
*/
class ps_nbpaynetz {
    var $classname = "ps_nbpaynetz";
    ...
    function show_configuration() {
        ...
        <table>
          ...
          <td><strong><?php echo "Paynetz Login Id" ?></strong></td>
              <td>
                  <input type="text" name="PAYNETZ_NB_LOGIN_ID" class="inputbox" value="<?php echo PAYNETZ_NB_LOGIN_ID ?>" />
              </td>
          ...
          <td><strong><?php echo "Paynetz Password" ?></strong></td>
              <td>
                  <input type="text" name="PAYNETZ_NB_PASSWORD" class="inputbox" value="<?php echo PAYNETZ_NB_PASSWORD ?>" />
              </td>
              <td><?php echo "Provided by ATOM" ?></td>
          </tr>
		   <tr>
          <td><strong><?php echo "Product Id" ?></strong></td>
              <td>
                  <input type="text" name="PAYNETZ_NB_PRODUCT_ID" class="inputbox" value="<?php echo PAYNETZ_NB_PRODUCT_ID ?>" />
              </td>
              <td><?php echo "As you wish" ?></td>
          </tr>
		    <tr>
                <td colaspan="3">
                  <input type="hidden" name="PAYNETZ_TRANSACTION_URL" value="http://203.114.240.77/paynetz/epi/fts" />
				  ...
				  <input type="hidden" name="PAYNETZ_CUST_ACCOUNT_NO" value="123456789012" />
				  <input type="hidden" name="PAYNETZ_NB_TTYPE" value="NBFundTransfer" />
             </td>
          </tr>
        </table>
        <?php
  ...
  /**
   ...
   function write_configuration( &$d ) {
      ...
      $my_config_array = array("PAYNETZ_NB_LOGIN_ID" => $d['PAYNETZ_NB_LOGIN_ID']
			 ,"PAYNETZ_NB_PASSWORD" => $d['PAYNETZ_NB_PASSWORD']
		  ,"PAYNETZ_NB_PRODUCT_ID" => $d['PAYNETZ_NB_PRODUCT_ID']
		  ...
		  ,"PAYNETZ_NB_TTYPE" => $d['PAYNETZ_NB_TTYPE']
                                      );
      $config = "<?php\n";
  ...
  ***************************************************************************/
   function process_payment($order_number, $order_total, &$d) {
	   ...
	   $param = array(
		   "login_id" => PAYNETZ_NB_LOGIN_ID
		   ,"password" => PAYNETZ_NB_PASSWORD
		   ,"prod_id" => PAYNETZ_NB_PRODUCT_ID
		   ,"ttype" => PAYNETZ_NB_TTYPE
